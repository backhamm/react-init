...
function Game() {
    ...
    return (
        <div className="Game">
            ...
            >
                <div>
                    <div className={`button ${index === '2' && 'active'}`} onClick={() => setIndex('2')} />
                    <div className={`button ${index === '3' && 'active'}`} onClick={() => setIndex('3')} />
                </div>
                <div className="header-right">
                    ...
                    <div className="img-btn1Ac" />
                </div>
            </motion.div>
            <div className="img-line1" />
            <motion.div
            ...
            >
                <div className="filter-left">
                    {filterArr.map(el => {
                        return (
                            <div key={el.groupId} className={filterId === el.groupId ? 'img-btn3Ac' : 'img-btn3'} onClick={() => setFilterId(el.groupId)}>
                                <span className="text">{el.groupName}</span>
                            </div>
                        )
                    })}
                    {gameList.length ? (
                        <Select
                            ...
                            label={t('desc3')}
                            afterIcon="img-drop"
                            className="img-selectBg"
                        />
                    ) : <></>}
                </div>
                <div className="img-search">
                    <input value={searchVal} onInput={e => setSearchVal(e.currentTarget.value)} className="input" type="text"/>
                </div>
            </motion.div>
            <motion.div
                initial={{y: -100, opacity: 0}}
                ...
                className="game-list"
            >
                {gameListFilter.map(el => (
                    <div key={el.machineId} className="img-gameBg" onClick={() => showMachine(el)}>
                        <div className="game-left">
                            <div className="img-content">
                                <img className="img" src={el.machineLog} alt=""/>
                            </div>
                            <div className={`game-sort img-tag${index}`}>
                                {gameInfo.groupName}
                            </div>
                        ...
                        <div className="game-right">
                            <div className="right-item">
                                <div className="title">{t('desc4')}</div>
                                <div className="value1">{el.courtyard}</div>
                            </div>
                            <div className="right-item">
                                <div className="title">{t('desc5')}</div>
                            ...
                            <div className="right-item">
                                <div className="title">{t('desc6')}</div>
                                <div className="value3">{el.count}</div>
                            </div>
                            <div className="right-item-last">
                                <span className="value">{el.gameCurrencyPrice}</span>
                                {t('desc7')}
                            </div>
                        </div>
                    </div>
